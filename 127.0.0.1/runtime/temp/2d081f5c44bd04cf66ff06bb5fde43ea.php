<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"C:\wwwroot\127.0.0.1\public/../application/admin\view\classfile\edit.html";i:1669277077;s:63:"C:\wwwroot\127.0.0.1\application\admin\view\layout\default.html";i:1669304756;s:60:"C:\wwwroot\127.0.0.1\application\admin\view\common\meta.html";i:1669304755;s:62:"C:\wwwroot\127.0.0.1\application\admin\view\common\script.html";i:1669304755;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Collegeclass_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-collegeclass_id" data-rule="required" data-source="collegeclass/index" data-field="class_name" class="form-control selectpage" name="row[collegeclass_id]" type="text" value="<?php echo htmlentities($row['collegeclass_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('File_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-file_name" class="form-control" name="row[file_name]" type="text" value="<?php echo htmlentities($row['file_name']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Class_file'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-class_file" class="form-control" size="50" name="row[class_file]" type="text" value="<?php echo htmlentities($row['class_file']); ?>">
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="faupload-class_file" class="btn btn-danger faupload" data-input-id="c-class_file" data-multiple="false" data-preview-id="p-class_file"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                    <span><button type="button" id="fachoose-class_file" class="btn btn-primary fachoose" data-input-id="c-class_file" data-multiple="false"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                </div>
                <span class="msg-box n-right" for="c-class_file"></span>
            </div>
            <ul class="row list-inline faupload-preview" id="p-class_file"></ul>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-refreshtime" class="form-control" name="row[refreshtime]" type="number" value="<?php echo htmlentities($row['refreshtime']); ?>">
        </div>
    </div>
    <div class="form-group">
