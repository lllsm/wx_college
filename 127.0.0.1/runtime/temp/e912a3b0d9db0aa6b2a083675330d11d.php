<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"C:\wwwroot\127.0.0.1\public/../application/admin\view\classimg\edit.html";i:1669356420;s:63:"C:\wwwroot\127.0.0.1\application\admin\view\layout\default.html";i:1669304756;s:60:"C:\wwwroot\127.0.0.1\application\admin\view\common\meta.html";i:1669304755;s:62:"C:\wwwroot\127.0.0.1\application\admin\view\common\script.html";i:1669304755;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Class_images'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-class_images" class="form-control" size="50" name="row[class_images]" type="text" value="<?php echo htmlentities($row['class_images']); ?>">
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="faupload-class_images" class="btn btn-danger faupload" data-input-id="c-class_images" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp,image/webp" data-multiple="true" data-preview-id="p-class_images"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                    <span><button type="button" id="fachoose-class_images" class="btn btn-primary fachoose" data-input-id="c-class_images" data-mimetype="image/*" data-multiple="true"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                </div>
                <span class="msg-box n-right" for="c-class_images"></span>
            </div>
            <ul class="row list-inline faupload-preview" id="p-class_images"></ul>
        </div>
    </div>
    <div class="form-group">
