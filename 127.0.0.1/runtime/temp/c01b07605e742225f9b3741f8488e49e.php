<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"C:\wwwroot\127.0.0.1\public/../application/admin\view\message\edit.html";i:1669183800;s:63:"C:\wwwroot\127.0.0.1\application\admin\view\layout\default.html";i:1669304756;s:60:"C:\wwwroot\127.0.0.1\application\admin\view\common\meta.html";i:1669304755;s:62:"C:\wwwroot\127.0.0.1\application\admin\view\common\script.html";i:1669304755;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-collegeclass_id" data-rule="required" data-field="class_name"  data-source="collegeclass/index" class="form-control selectpage" name="row[collegeclass_id]" type="text" value="<?php echo htmlentities($row['collegeclass_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Msg_t'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-msg_t" class="form-control " rows="5" name="row[msg_t]" cols="50"><?php echo htmlentities($row['msg_t']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
