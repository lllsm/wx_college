<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\wwwroot\127.0.0.1\public/../application/admin\view\carousel\add.html";i:1673592075;s:63:"D:\wwwroot\127.0.0.1\application\admin\view\layout\default.html";i:1669304756;s:60:"D:\wwwroot\127.0.0.1\application\admin\view\common\meta.html";i:1669304754;s:62:"D:\wwwroot\127.0.0.1\application\admin\view\common\script.html";i:1669304754;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Name_text'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-name_text" class="form-control" name="row[name_text]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Address_page'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-address_page" class="form-control" name="row[address_page]" type="text">
        </div>
    </div>
    <div class="form-group">
