<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\wwwroot\127.0.0.1\public/../application/admin\view\information\edit.html";i:1674982797;s:63:"D:\wwwroot\127.0.0.1\application\admin\view\layout\default.html";i:1669304756;s:60:"D:\wwwroot\127.0.0.1\application\admin\view\common\meta.html";i:1669304754;s:62:"D:\wwwroot\127.0.0.1\application\admin\view\common\script.html";i:1669304754;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Subhead'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-subhead" class="form-control" name="row[subhead]" type="text" value="<?php echo htmlentities($row['subhead']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Readnum'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-readnum" min="0" class="form-control" name="row[readnum]" type="number" value="<?php echo htmlentities($row['readnum']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Resource'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-resource" class="form-control" name="row[resource]" type="text" value="<?php echo htmlentities($row['resource']); ?>">
        </div>
    </div>
    <div class="form-group">
