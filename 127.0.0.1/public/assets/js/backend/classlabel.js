define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'classlabel/index' + location.search,
                    add_url: 'classlabel/add',
                    edit_url: 'classlabel/edit',
                    del_url: 'classlabel/del',
                    multi_url: 'classlabel/multi',
                    import_url: 'classlabel/import',
                    table: 'classlabel',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'classlabel/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
